...
export default function OutreachSettingsPanel() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Outreach Settings</h1>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-medium text-gray-900">Outreach System</h3>
      ...
      <div className="bg-white rounded-lg border border-gray-200">
        ...
        <div className="p-6">
          ...
          {activeTab === 'templates' && (
            <div className="space-y-6">
              <h3 className="text-lg font-medium text-gray-900">Email Subject Templates</h3>
          ...
          {activeTab === 'automation' && (
            <div className="space-y-6">
              <h3 className="text-lg font-medium text-gray-900">Auto-Reply Settings</h3>
