    ...
    return (
      <div className="max-w-4xl mx-auto p-6">
        <div className="text-center py-8">
          <p className="text-red-600">Failed to load outreach configuration</p>
          <button 
        ...
        <div className="p-6">
          ...
          {activeTab === 'general' && (
            <div className="space-y-6">
              {/* Channel Settings */}
              <div>
                <h3 className="text-lg font-medium text-gray-900 mb-4">Message Channels</h3>
                  ...
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600">Send outreach via email</div>
                      </div>
                    </div>
                    <input
                      type="checkbox"
                  ...
                  <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600">Send outreach via text message</div>
                      </div>
                    </div>
                    <input
                      type="checkbox"
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 bg-gray-800 border border-[#222222] rounded-md focus:outline-none focus:ring-2 focus:ring-primary text-white"
                    >
              ...
              {/* Sending Hours */}
              <div>
                <h3 className="text-lg font-medium text-gray-900 mb-4">Sending Hours</h3>
          ...
          {activeTab === 'templates' && (
            <div className="space-y-6">
              ...
              {Object.entries(config.templates).map(([type, template]) => (
                <div key={type} className="bg-gray-800 border border-[#222222] rounded-lg p-4">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-gray-700 border border-[#222222] rounded-md focus:outline-none focus:ring-2 focus:ring-primary text-white disabled:bg-gray-900 disabled:text-gray-500"
                  />
                </div>
              ))}
            </div>
                ...
                {config.targeting.excludeRecentlyContacted && (
                  <div className="mt-2 ml-6">
                    ...
                    <input
                      ...
                      className="w-32 px-3 py-2 bg-gray-800 border border-[#222222] rounded-md focus:outline-none focus:ring-2 focus:ring-primary text-white"
                    />
                  </div>
                )}
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h4 className="font-medium text-gray-900">Auto-Reply to Interest</h4>
