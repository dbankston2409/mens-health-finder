  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-6">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Sales Snapshot</h2>
        <button 
          onClick={onRefresh}
        ...
        <>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
              <div className="text-gray-500 dark:text-gray-400 text-sm mb-1">Annual Revenue</div>
            ...
            {/* Churned Accounts */}
            <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
              <div className="text-gray-500 dark:text-gray-400 text-sm mb-1">Churned Accounts</div>
              <div className="text-xl font-semibold text-gray-900 dark:text-white">
          ...
          {data.subscriptionsByPlan && Object.keys(data.subscriptionsByPlan).length > 0 && (
            <div className="mt-6">
              <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Subscriptions by Plan</h3>
              <div className="grid grid-cols-3 gap-2">
                {Object.entries(data.subscriptionsByPlan).map(([plan, count]) => (
                  <div key={plan} className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3 text-center">
                    <div className="text-xs text-gray-500 dark:text-gray-400 mb-1 capitalize">{plan}</div>
