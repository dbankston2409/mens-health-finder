...
const Login = () => {
  ...
  return (
    <>
      <Head>
        <title>Login | Men's Health Finder</title>
        <meta name="description" content="Sign in to your Men's Health Finder account" />
      </Head>
      <div className="min-h-screen flex items-center justify-center px-4 py-12">
        <div className="glass-card p-8 w-full max-w-md">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold mb-2">Sign In to Men's Health Finder</h1>
            <p className="text-[#AAAAAA]">Access your saved clinics and more</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="/forgot-password" className="text-sm text-primary hover:text-red-400">
                  Forgot password?
                </Link>
              </div>
              <input
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-[#111111] text-[#AAAAAA]">Or continue with</span>
            </div>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-[#AAAAAA]">
            ...
            <Link href="/signup" className="text-primary hover:text-red-400 font-medium">
              Sign up
            </Link>
          </p>
        </div>
