                  ...
                  <div className="flex flex-col gap-4">
                    <div className="flex-1 text-center">
                      <div className="flex justify-center items-center space-x-4 mb-2">
                        <label className="inline-block text-sm text-[#AAAAAA]">Location</label>
                        <button 
                          type="button" 
                      ...
                      <div className="relative max-w-md mx-auto">
                        ...
                        />
                        <svg className="w-5 h-5 absolute left-3 top-1/2 transform -translate-y-1/2 text-[#777777]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                        </svg>
                      </div>
                      {locationError && (
                        <p className="text-xs text-red-400 mt-1 text-center">{locationError}</p>
                      )}
                    </div>
                  </div>
              ...
              <div key={clinic.id} className="card overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-2">
                    <Link 
                      href={createClinicUrl(clinic.services[0], clinic)} 
                      className="btn flex-1 py-2 px-0"
                    >
                      View Profile
                    </Link>
                    <button className="btn-secondary flex-none py-2 px-3">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-12">
            {[
              ...
              <div key={index} className="text-center">
                <div className="circle-icon w-16 h-16 mx-auto">
                  {item.icon}
                </div>
