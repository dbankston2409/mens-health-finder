...
const TierBadge: React.FC<TierBadgeProps> = ({ tier, size = 'md' }) => {
  ...
  switch (tier) {
    case 'high':
      badgeText = 'DELUXE VERIFIED PROVIDER';
      badgeColor = 'bg-gradient-to-r from-yellow-600 to-yellow-400';
      tooltipText = 'This provider has completed our deluxe verification process and maintains a premium listing on Men\'s Health Finder.';
      break;
    case 'low':
