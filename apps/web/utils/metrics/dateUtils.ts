 ...
 */
export function getStartOfMonth(date: Date = new Date()): Timestamp {
 ...
 */
export function getStartOfYear(date: Date = new Date()): Timestamp {
 ...
 */
export function getDateDaysAgo(daysAgo: number, date: Date = new Date()): Timestamp {
 ...
 */
export function getDateRange(daysAgo: number, date: Date = new Date()): { startDate: Timestamp, endDate: Timestamp } {
 ...
 */
export function getMonthKey(timestamp: Timestamp): string {
 ...
 */
export function isCurrentMonth(timestamp: Timestamp): boolean {
  const now = new Date();
  const date = timestamp.toDate();
 ...
 */
export function isCurrentYear(timestamp: Timestamp): boolean {
  const now = new Date();
  const date = timestamp.toDate();
